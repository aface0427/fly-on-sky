...
static void TFMini2_Check_Reset()
{
	tf2_offline_check_time = 0;
	tfmini2.offline = 0;
}
void TFmini2_Offline_Check(u8 dT_ms)
{
	if(tf2_offline_check_time<TFMINI2_OFFLINE_TIME_MS)
	{
		tf2_offline_check_time += dT_ms;
	}
	else
	{
		tfmini2.offline = 1;
